...
export const Home = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center w-screen py-32 text-center">
      ...
      <OurMission/>
      <div className="flex flex-col justify-center items-center w-screen h-screen mt-24 text-center bg-pasta bg-cover ">
        <h1 id="recipes" className="font-semibold text-5xl pb-12 text-green-800 -translate-y-52">
          What are you waiting for?
        </h1>
        <Link to="/allrecipes">
        <button
          
          className="mt-4 inline-flex items-center justify-center text-xl p-4 px-6 py-3 font-bold text-green-800 bg-white border-2 border-white rounded-full shadow-2xl hover:bg-white hover:text-green-500 duration-300 -translate-y-52"
        >
          Start exploring
        </button>
        </Link>
